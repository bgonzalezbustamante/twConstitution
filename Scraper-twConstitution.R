...
save_as_csv(apruebo_tweets, 'dataCollection/20201003_twApruebo.csv', 
            prepend_ids = TRUE, na = "", fileEncoding = "UTF-8")

## test1 <- read.csv("dataCollection/20201003_twApruebo.csv", header = T, sep = ",")
## rm(test1)

save_as_csv(rechazo_tweets, 'dataCollection/20201003_twRechazo.csv', 
            prepend_ids = TRUE, na = "", fileEncoding = "UTF-8")

## test2 <- read.csv("dataCollection/20201003_twRechazo.csv", header = T, sep = ",")
## rm(test2)
